// ...existing code from frontend/src/components/agents/UserMessage.tsx...
...
export function UserMessage({ message, onEditMessage }: IUserMessageProps): JSX.Element {
  ...
  return (
    <CopilotUserMessage
      ...
      timestamp={message.more?.time ? formatTimestamp(new Date(message.more.time)) : ""}
    >
