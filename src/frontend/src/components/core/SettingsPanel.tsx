// ...existing code from frontend/src/components/core/SettingsPanel.tsx...
...
export function SettingsPanel({ isOpen = false, onOpenChange }: ISettingsPanelProps): JSX.Element {
  return (
    <Drawer
